---
description: Extract a project's ubiquitous language (domain term → definition → code symbol) into a project-tier glossary.md the rule-prime hook primes and /review cites — the meaning leg beside codemap's structure and extract-conventions' style. Per-group propose-confirm.
---
