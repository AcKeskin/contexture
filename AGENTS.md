...
- **No internal R&D vocabulary in shipped code** — never embed proposal/issue numbers or other private-repo identifiers (e.g. ``, internal ticket ids) in committed code or comments. Describe the *concept* instead. Symptom: the public snapshot carries dangling references to a repo nobody can see.
