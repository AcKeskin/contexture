...
export const FIXTURES = [
  {
    ...
    files: {
      ...
      // Type-resolution fixture: two classes both declare get(); typed receivers must disambiguate.
      'app/store.ts':
    ...
    // edge. `builtinCallee` drives the [precision] check. `resolution` drives the [resolution]
...

  {
    ...
    // `resolution` drives the [resolution] check: r.Get()/c.Get() must resolve to
