...
**Seed:** lifted from [Lemma](https://github.com/xenitV1/lemma) `src/memory/privacy.ts` at examination time (2026-04-27, MIT licensed). Original 17 patterns kept verbatim. Four patterns added for shapes Lemma lacked (Anthropic, fine-grained GitHub PAT, Stripe live keys, JWT). Total **21 patterns**.
...
| Date       | Change                                          | Reason                                                                                                |
|------------|-------------------------------------------------|-------------------------------------------------------------------------------------------------------|
| 2026-04-27 | Initial set: 17 verbatim from Lemma + 4 added   | Lemma's `src/memory/privacy.ts`, MIT. Added: `anthropic-api-key`, `github-fine-grained-pat`, `stripe-live-*` (×2), `jwt`. |
