...
description: "The project's default autonomy posture — how hard to push, when to stop, when to ask — that /autonomize and the workflow organs read when no per-task or live contract is set. Override per project via the user/project overlay tier."
type: user
